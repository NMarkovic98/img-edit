...
import { Wand2, Sparkles, ArrowRight, Zap, Shield, Users, Star, Twitter } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6 rounded-xl bg-card/50 border shadow-lg hover:shadow-xl transition-all duration-300 mobile-card touch-target">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                Generate edited images in seconds using Nano Banana Pro via fal.ai
              </p>
            </div>
            ...
            <div className="text-center p-4 sm:p-6 rounded-xl bg-card/50 border shadow-lg hover:shadow-xl transition-all duration-300 mobile-card touch-target">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Smart Analysis</h3>
              <p className="text-sm sm:text-base text-muted-foreground">
                Gemini 2.5 Flash analyzes Reddit posts and generates precise editing instructions
              </p>
            </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="text-center mobile-card">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto mb-4 shadow-lg touch-target">1</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Analyze</h3>
              <p className="text-sm sm:text-base text-muted-foreground">AI analyzes Reddit posts and generates detailed edit instructions</p>
            </div>
            <div className="text-center mobile-card">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto mb-4 shadow-lg touch-target">2</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Edit</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Customize prompts and generate AI-enhanced images instantly</p>
            </div>
            <div className="text-center mobile-card">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto mb-4 shadow-lg touch-target">3</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">Download</h3>
              <p className="text-sm sm:text-base text-muted-foreground">Download your edits and share with the community</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-6 sm:mb-8 mobile-responsive-text">
              Start editing images with AI-powered precision
            </p>
            <Link href="/app">
              <Button size="lg" className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-primary-foreground font-semibold px-6 sm:px-8 py-3 shadow-lg hover:shadow-xl transition-all duration-300 mobile-button w-full sm:w-auto">
                <Wand2 className="mr-2 h-5 w-5" />
                Launch Fixtral
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
        ...
        <div className="container mx-auto px-4 py-6 sm:py-8 mobile-container">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-4 sm:space-x-6">
              <a href="https://www.x.com/anjumfariz" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors touch-target p-2 rounded-lg hover:bg-muted/50" aria-label="Follow us on X">
                <Twitter className="h-5 w-5" />
              </a>
              <a href="https://www.github.com/farizanjum" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors touch-target p-2 rounded-lg hover:bg-muted/50" aria-label="GitHub">
          ...
          <div className="text-center mt-6 sm:mt-8 pt-6 sm:pt-8 border-t text-sm text-muted-foreground">
            <p>&copy; 2025 Fixtral. Built with Next.js, Tailwind CSS, and Google Gemini AI.</p>
            <p className="mt-2">Made with love by Fariz Anjum</p>
          </div>
        </div>
      </footer>
    </div>
